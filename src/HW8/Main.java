...
public class Main {
    public static void main(String[] args) {
        ...
        library.takeABook(new KeyDate(2021, 5, 1), books);
        System.out.println("Books for this day is - " + library.searchByDates(new KeyDate(2021, 5, 1)));
        System.out.println("******************");
        System.out.println("Range of dates of taken books " + library.getAllDates());
        System.out.println("list of books for a whole range" + library.getAllBooks());
        //System.out.println(library.rangeForOneMonth());
